...
import { playerAnalyticsLiveAdComplete } from '../analytics-ingestion-v3';
import { getLivePlayerAnalyticsBaseInfo } from './utils/getLivePlayerAnalyticsBaseInfo';

export function trackLiveAdComplete(event: LiveAdEventData, { wrapper, contentId, videoPlayer, ssaiVersion }: { wrapper: LivePlayerWrapper, contentId: string, videoPlayer: PlayerDisplayMode, ssaiVersion: string }) {
  ...
  playerAnalyticsLiveAdComplete(data);
}
