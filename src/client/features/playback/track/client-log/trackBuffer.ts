...
export function getParamsFromPlayer(player: InstanceType<typeof Player> | InstanceType<typeof LivePlayerWrapper>,) {
  ...
  return {
    ...
    sdkVersion,
    isAd,
    contentBwEstimate: toFixed2(player.getBandwidthEstimate() / 1000), // kbps
...
export function trackBufferStart({
  ...
  durationSinceLastQualityChange,
  lastQualityChangeDirection,
}: {
    ...
    durationSinceLastQualityChange?: number,
    lastQualityChangeDirection?: string,
  }) {
...
export function trackRebufferTime({
  ...
  audioBufferHole,
  bufferingType,
  nearestVideoBufferRangesAtEnd,
  nearestAudioBufferRangesAtEnd,
  ...
  showingUIComponentsAtStart,
    ...
    videoBufferHole?: number,
    audioBufferHole?: number,
    bufferingType?: BufferingType,
    nearestVideoBufferRangesAtEnd?: ArrayedTimeRange[],
    nearestAudioBufferRangesAtEnd?: ArrayedTimeRange[],
    decodedFramesAtStart?: number,
    contentBwEstimateAtStart?: number,
    fragDownloadInfoAtStart?: FragDownloadInfo,
    bufferEndOperation?: BUFFER_END_OPERATION,
    elReadyStateAtStart: number | undefined,
    bufferDataState?: BufferDataState,
    videoResource?: VideoResource,
    showingUIComponentsAtStart?: string[],
  }) {
