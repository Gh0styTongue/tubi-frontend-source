...
declare module 'common/experiments/ExperimentManager' {
  export namespace TubiExperiments {
    export let ottVizioSkipAdWithHealthscore: 'webott_vizio_skip_ad_with_healthscore_v1';
  }
}

TubiExperiments.ottVizioSkipAdWithHealthscore = 'webott_vizio_skip_ad_with_healthscore_v1';
...
export const VIZIO_SKIP_AD_WITH_HEALTHSCORE = {
  namespace: 'webott_vizio_skip_ad_with_healthscore_v1',
...
export const getConfig = () => {
  return {
    ...
    experimentName: 'webott_vizio_skip_ad_with_healthscore_v1',
