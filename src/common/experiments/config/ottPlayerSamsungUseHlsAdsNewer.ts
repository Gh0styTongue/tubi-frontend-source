...
declare module 'common/experiments/ExperimentManager' {
  export namespace TubiExperiments {
    export let ottPlayerSamsungUseHlsAdsNewer: 'webott_player_ott_samsung_hls_ads_v6';
  }
}

TubiExperiments.ottPlayerSamsungUseHlsAdsNewer = 'webott_player_ott_samsung_hls_ads_v6';
...
export const getConfig = () => {
  return {
    ...
    experimentName: 'webott_player_ott_samsung_hls_ads_v6',
    defaultValue: false,
    treatments: [
