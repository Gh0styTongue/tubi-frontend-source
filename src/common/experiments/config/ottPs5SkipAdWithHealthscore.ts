...
declare module 'common/experiments/ExperimentManager' {
  export namespace TubiExperiments {
    export let ottPs5SkipAdWithHealthscore: 'webott_ps5_skip_ad_with_healthscore_v1';
  }
}

TubiExperiments.ottPs5SkipAdWithHealthscore = 'webott_ps5_skip_ad_with_healthscore_v1';
...
export const PS5_SKIP_AD_WITH_HEALTHSCORE = {
  namespace: 'webott_ps5_skip_ad_with_healthscore_v1',
...
export const getConfig = () => {
  return {
    ...
    experimentName: 'webott_ps5_skip_ad_with_healthscore_v1',
