...
// Time threshold (in seconds) for showing registration gate during video playback
export const VIDEO_REG_GATE_TIME_THRESHOLD = 15 * 60; // 15 minutes in seconds

export const FAIRPLAY_SERVER_CERT_URL = 'https://fairplay.keyos.com/api/v4/getCertificate?certHash=9c6bf173c89372a38ddee01d125ce8a5';
