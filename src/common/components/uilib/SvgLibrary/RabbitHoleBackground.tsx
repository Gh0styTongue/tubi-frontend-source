...
const RabbitHoleBackground = ({
  ...
  // Determine the fill for the main background area (outside rabbit hole)
  const mainBackgroundFill = backgroundImage ? 'url(#backgroundImagePattern)' : 'url(#paint0_linear_1430_1531)';
  ...
  return <svg width="1920" height="1080" viewBox="0 0 1920 1080" fill="none" xmlns="http://www.w3.org/2000/svg" className={styles.rabbitHole}>
    ...
    <path fillRule="evenodd" clipRule="evenodd" d="M896.508 0H0V1080H1062.86C899.93 907.96 800 675.65 800 420C800 269.381 834.687 126.864 896.508 0Z" fill={mainBackgroundFill} />
    <rect width="1920" height="1080" fill="url(#paint0_linear_1430_1534)" />
    <defs>
      {backgroundImage && (
        <pattern id="backgroundImagePattern" patternUnits="userSpaceOnUse" width="1920" height="1080">
          <image href={backgroundImage} width="1920" height="1080" preserveAspectRatio="xMidYMid slice" />
        </pattern>
      )}
