...
import Vents from './images/vents.svg';
...
const messages = defineMessages({
  ...
  reportIPIssuesLink: {
    description: 'Web footer "Report IP Issues" link in the SUPPORT column',
    defaultMessage: 'Report IP Issues',
  },
  // partners
  partnersColumnTitle: {
  ...
  termsOfUseLink: {
    description: 'Web footer "Terms of Use" link in the LEGAL column',
  ...
  adsRegistry: {
    description: 'CA ads registry link text',
    defaultMessage: 'Ads Registry',
  },
});
...
const Footer: React.FunctionComponent<FooterProps> = (
  { cls, contentId = '', isSpanishLanguage, useRefreshStyle, isUsCountry, inverted, deviceId, isProjectorVariant },
) => {
  const { formatMessage } = useIntl();
  const isGDPREnabled = useAppSelector(isGDPREnabledSelector);
  const twoDigitCountryCode = useAppSelector((state) => state.ui.twoDigitCountryCode);
  const footerCls = classNames(
    styles.footer,
    {
      [styles.webRefresh]: useRefreshStyle,
      [styles.inverted]: inverted,
      [styles.projectorVariant]: isProjectorVariant,
    },
    cls
  );
  ...
  return (
    <div className={footerCls}>
      {isProjectorVariant ? (
        <React.Fragment>
          <div className={styles.projectorViewport} aria-hidden="true">
            <div className={styles.projector}>
              <div className={styles.projectorLensOutline} />
              <div className={styles.projectorLensFill} />
              <div className={styles.projectorBody} />
              <div className={styles.projectorScrewLeft} />
              <div className={styles.projectorScrewRight} />
            </div>
          </div>
          <div className={classNames(styles.containerTop, styles.projectorVariant)}>
            <img className={styles.maskOverlay} src={MaskGroup} alt="" aria-hidden="true" />
            <div className={styles.topLights} aria-hidden="true">
            ...
            <img className={styles.ventsOverlay} src={Vents} alt="" aria-hidden="true" />
            <Row>
      ...
      <Container className={classNames(styles.container, { [styles.projectorVariant]: isProjectorVariant })}>
        {!isProjectorVariant ? (
          <React.Fragment>
            <Row className={styles.topRow}>
              <div className={styles.iconAndPath}>
        ...
        <Row className={styles.listContainer}>
          ...
          <Col {...colProps}>
            <ul className={styles.links}>
              ...
              <li>
                <ATag to={WEB_ROUTES.IPRDLanding}>{formatMessage(messages.reportIPIssuesLink)}</ATag>
              </li>
            </ul>
          </Col>
          <Col {...colProps}>
            <ul className={styles.links}>
              ...
              {twoDigitCountryCode === 'CA' ? (
                <li>
                  <ATag to={WEB_ROUTES.caAdsRegistry}>{formatMessage(messages.adsRegistry)}</ATag>
                </li>
              ) : null}
            </ul>
          </Col>
