...
export const LandingPage = () => {
  ...
  const startWatchingBlockHeader = LANDING_PAGE_TEXT.startWatchingBlock.header;
  const startWatchingBlockSubheader = [LANDING_PAGE_TEXT.startWatchingBlock.subheader];
