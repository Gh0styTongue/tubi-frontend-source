...
const messages = defineMessages({
  deleteWatch: {
    description: 'Remove All From Continue Watching button text',
    defaultMessage: 'Remove All From Continue Watching',
  },
  deleteQueue: {
...
const History: React.FC<HistoryProps> = ({
  ...
  const handleHeaderClick = useCallback((index: number) => {
