...
export class Container extends Component<ContainerProps> {
  ...
  getMeta = () => {
    ...
    const containerUrl = getContainerUrl(id, { type });
    const canonical = getCanonicalLink(containerUrl);
    ...
    const isCategoryPage = matchesRoute(WEB_ROUTES.categoryIdTitle, containerUrl);
    ...
    return {
      ...
      link: [
        ...
        ...(isCategoryPage ? getAlternateMeta(containerUrl) : []),
      ],
      meta: [
        {
          name: 'keywords',
