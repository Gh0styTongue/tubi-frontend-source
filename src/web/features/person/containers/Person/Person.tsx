...
import PersonPageGraphSchema from 'web/features/seo/components/PersonPageGraphSchema/PersonPageGraphSchema';
...
const Person: TubiContainerFC<Props, RouteParams> = ({ params }) => {
  ...
  return (
    <div className={styles.root}>
      <Helmet {...helmetProps} />
      <PersonPageGraphSchema name={name} videos={videos} />
