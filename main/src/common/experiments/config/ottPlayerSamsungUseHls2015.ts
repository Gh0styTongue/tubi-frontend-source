...
declare module 'common/experiments/ExperimentManager' {
  export namespace TubiExperiments {
    export let ottPlayerSamsungUseHls2015: 'webott_player_ott_samsung_use_hlsjs_2015_v1';
  }
}

TubiExperiments.ottPlayerSamsungUseHls2015 = 'webott_player_ott_samsung_use_hlsjs_2015_v1';
...
export const getConfig = () => {
  return {
    ...
    experimentName: 'webott_player_ott_samsung_use_hlsjs_2015_v1',
    defaultValue: false,
    treatments: [
