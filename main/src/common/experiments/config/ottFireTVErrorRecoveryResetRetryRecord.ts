...
declare module 'common/experiments/ExperimentManager' {
  export namespace TubiExperiments {
    export let ottFireTVErrorRecoveryResetRetryRecord: 'webott_firetv_error_recovery_reset_retry_record_v0';
  }
}

TubiExperiments.ottFireTVErrorRecoveryResetRetryRecord = 'webott_firetv_error_recovery_reset_retry_record_v0';

export const FIRETV_ERROR_RECOVERY_RESET_RETRY_RECORD = {
  namespace: 'webott_firetv_error_recovery_reset_retry_record',
  parameter: 'reset_retry_record_v0',
};
...
export const getConfig = (): ExperimentConfig<TreatmentValue, TreatmentName> => {
  return {
    ...
    experimentName: 'webott_firetv_error_recovery_reset_retry_record_v0',
    defaultValue: false,
    inYoubora: true,
    treatments: [
