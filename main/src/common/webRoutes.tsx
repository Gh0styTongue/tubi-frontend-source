...
import {
  ...
  ageUnavailableRedirectHook,
  superbowlOnEnterHook,
  disasterModeOnEnterHook,
...
const messages = defineMessages({
  ...
  dashpass: {
    description: 'dashpass offer terms and conditions page title',
    defaultMessage: 'DashPass Offer Terms and Conditions',
  },
  privacy: {
...
export default (store: Store) => {
  ...
  const ageUnavailableRedirect = ageUnavailableRedirectHook.bind(null, store);
  const superbowlOnEnter = superbowlOnEnterHook.bind(null, store);
  const disasterModeOnEnter = disasterModeOnEnterHook.bind(null, store);
  ...
  return (
    <Route path={WEB_ROUTES.home} onEnter={appOnEnter} component={App}>
      ...
      <Route
        path={WEB_ROUTES.superBowl}
        getComponent={
          lazy(() => import(
            /* webpackChunkName: "web-superbowl" */
            'web/features/purpleCarpet/containers/SuperBowl/SuperBowl'
          ))
        }
        onEnter={superbowlOnEnter}
      />

      <Route
        path={WEB_ROUTES.howToWatchSuperBowl}
        getComponent={
          lazy(() => import(
            /* webpackChunkName: "web-superbowl" */
            'web/features/purpleCarpet/containers/SuperBowl/HowToWatchSuperBowl'
          ))
        }
        onEnter={superbowlOnEnter}
      />
      ...
      <Route
        path={WEB_ROUTES.legalFiRedirect}
        getComponent={
          lazy(() => import(
            /* webpackChunkName: "web-superbowl" */
            'web/containers/LegalDoc/LegalDocFiRedirect'
          ))
        }
      />
      ...
      <ExactRoute
        path={WEB_ROUTES.dashpassEmbedded}
        legalType={LEGAL_TYPES.dashpass}
        embedded
        titleMessageDescriptor={messages.dashpass}
        onEnter={() => {
          store.dispatch(setTopNavVisibleState(false));
        }}
        onLeave={() => {
        ...
        getComponent={
          lazy(() => import(
            /* webpackChunkName: "web-dashpass" */
            'web/containers/LegalDoc/LegalDoc'
          ))
        }
      />
      <Redirect from={WEB_ROUTES.dashpassRedirect} to={WEB_ROUTES.dashpass} />
      <ExactRoute
        path={WEB_ROUTES.dashpass}
        legalType={LEGAL_TYPES.dashpass}
        titleMessageDescriptor={messages.dashpass}
        getComponent={
          lazy(() => import(
      ...
      <Route path={WEB_ROUTES.ageUnavailable} onEnter={ageUnavailableRedirect} />
    </Route>
  );
};
