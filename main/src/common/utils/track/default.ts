...
export function trackEvent(arg1: Parameters<typeof typeTrackEvent>[0], arg2: Parameters<typeof typeTrackEvent>[1], arg3?: Parameters<typeof typeTrackEvent>[2]): ReturnType<typeof typeTrackEvent> {
  if (depTrackEvent === undefined) {
    throw new Error('dependency trackEvent not injected');
  }
  return depTrackEvent(arg1, arg2, arg3);
}
