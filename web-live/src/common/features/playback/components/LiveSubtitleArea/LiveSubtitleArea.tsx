...
import type { OTTCaptionsStyle, WebCaptionsStyle } from '@adrise/player';
...
export const LiveSubtitleArea: FunctionComponent<LiveSubtitleAreaProps> = ({
  ...
  const [lines, setLines] = useState<VTTCue[]>([]);
  ...
  const renderStaticSubtitles = (lines: VTTCue[]) => <div className="subtitleWindow" data-test-id="subtitleWindow" style={captionStyle.window}>
...
export default connect(mapStateToProps)(LiveSubtitleArea) as React.FC<Partial<LiveSubtitleAreaProps>>;
