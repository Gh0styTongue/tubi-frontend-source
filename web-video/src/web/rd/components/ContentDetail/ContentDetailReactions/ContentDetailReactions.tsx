...
const ContentDetailReactions = ({ contentId: videoContentId, seriesContentId }: ContentDetailReactionsProps) => {
  ...
  const shouldDisplayContent = !!bp && (!isLoggedIn || !!userReaction || isMajorEventFailsafe);
  const responsiveMode = bp?.lg ? 'tooltip' : 'text';
  ...
  return (
    <div className={styles.contentDetailReactions}>
