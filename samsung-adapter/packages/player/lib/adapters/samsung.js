...
var SamsungAdapter = /** @class */ (function (_super) {
    ...
    SamsungAdapter.prototype.skipBrokenAd = function (err) {
        var _this = this;
        var _a = this, adCount = _a.adCount, adPosition = _a.adPosition, currentAd = _a.currentAd, adSequence = _a.adSequence;
        ...
        adTools.sendVASTErrorBeacon(currentAd, vastErrorCode, function (err) {
    ...
    SamsungAdapter.prototype.play = function () {
        ...
        if (this.isAd() && ((_a = this.adPodPlaybackDetail) === null || _a === void 0 ? void 0 : _a.pauseStartTimestamp)) {
            this.adPodPlaybackDetail.pauseDuration += (0, time_1.timeDiffInMilliseconds)(this.adPodPlaybackDetail.pauseStartTimestamp, (0, time_1.now)());
    ...
    SamsungAdapter.prototype.playNextAd = function () {
        ...
        if (!currentAd) {
            ...
            this.resume(this.isPreroll());
            return;
        }
        this.log('playNextAd', currentAd);
        this.adTrackFn = adTools.getAdTrackFn(currentAd, function (err) {
    ...
    SamsungAdapter.prototype.resume = function (isFromPreroll) {
        /* istanbul ignore next */
        if (this.isTerminated)
            return;
        this.emit(event_1.PLAYER_EVENTS.startLoad, {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, fetchWrapper_1.fetchWrapper)(this.mediaUrl, {}, !!this.config.forceFetchPolyfill)];
                    case 1:
                        res = _a.sent();
