...
export default defineMessages({
  ...
  termsAgreement: {
    description: 'legal agreement copy for terms and privacy',
    defaultMessage: 'By continuing, you agree that you have read and understood Tubi\'s <privacyLink>Privacy Policy</privacyLink> and agree to Tubi\'s <termsLink>Terms of Use</termsLink>.',
  },
});
