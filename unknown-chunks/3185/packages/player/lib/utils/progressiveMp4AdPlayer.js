...
var ProgressiveMp4AdPlayer = /** @class */ (function (_super) {
    ...
    function ProgressiveMp4AdPlayer(options) {
        ...
        _this.onLoadeddata = function () {
            ...
            var _b = _this, adSequence = _b.adSequence, adCount = _b.adCount, isPreroll = _b.isPreroll;
            ...
            if ((_a = _this.adPreloader) === null || _a === void 0 ? void 0 : _a.isLoaded(currentAd.video)) {
                _this.adPreloader.setAsUtilized(currentAd.video);
            }
        ...
        _this.onCanPlayThrough = function () {
            _this.log('onCanPlayThrough', _this.state);
            if (_this.options.adPreloadMethod === 'preload_per_ad') {
                _this.preloadNextAd();
            }
        };
        ...
        _this.adPreloader = options.adPreloader;
        return _this;
    }
    /**
     * Play ad response
    ...
    ProgressiveMp4AdPlayer.prototype.remove = function () {
        ...
        (_c = this.adPreloader) === null || _c === void 0 ? void 0 : _c.reset(this.options.adPreloadFallbackImmediately);
    ...
    ProgressiveMp4AdPlayer.prototype.playNextAd = function () {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var previousAd, currentAd, adPodDuration, adUrl, blobUrl, e_1;
            var _this = this;
            return tslib_1.__generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        clearTimeout(this.adNoBufferDetectionTimer);
                        previousAd = this.getCurrentAdWithState();
                        ...
                        adUrl = currentAd.video;
                        if (!this.adPreloader) return [3 /*break*/, 5];
                        _e.label = 1;
                    case 1:
                        _e.trys.push([1, 4, , 5]);
                        if (!(this.adPreloader.isLoaded(currentAd.video)
                            || (!this.options.adPreloadFallbackImmediately && this.adPreloader.isKnown(currentAd.video)))) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.adPreloader.getPromiseFor(currentAd.video)];
                    case 2:
                        blobUrl = (_e.sent()).response;
                        adUrl = blobUrl;
                        _e.label = 3;
                    ...
                    case 5:
                        if (this.options.performanceCollectorEnabled) {
                            this.performanceCollector = new performanceCollector_1.PerformanceCollector({
                                ...
                                reporter: function (metrics) {
                                    var _a;
                                    return _this.emit(constants_1.PLAYER_EVENTS.startupPerformance, {
                                        isAd: true,
                                        ad: currentAd,
                                        ...
                                        metrics: metrics,
                                        preloaded: !!((_a = _this.adPreloader) === null || _a === void 0 ? void 0 : _a.isLoaded(currentAd.video)),
                                    });
                                },
                            });
    ...
    ProgressiveMp4AdPlayer.prototype.preloadNextAd = function () {
        var _a = this.options.adPreloadTimeout, adPreloadTimeout = _a === void 0 ? (0, time_1.secs)(10) : _a;
        var ad = this.getNextAdWithState();
        if (!ad || !this.adPreloader)
            return;
        this.adPreloader.add(ad.video, 1, adPreloadTimeout, {
            adId: ad.id,
            adPosition: this.adSequence,
            adCount: this.adCount,
            isPreroll: this.isPreroll,
        });
    };
    ProgressiveMp4AdPlayer.prototype.removePreloadedAd = function () {
        var currentAd = this.getCurrentAdWithState();
        if (!currentAd || !this.adPreloader)
            return;
        if (this.adPreloader.isKnown(currentAd.video)
            && (!this.options.adPreloadFallbackImmediately || !this.adPreloader.isInFlight(currentAd.video))) {
            this.adPreloader.remove(currentAd.video, true);
        }
    };
    ...
    ProgressiveMp4AdPlayer.prototype.getAdErrorEventData = function (ad) {
        return tslib_1.__assign({ ad: ad, adSequence: this.adSequence, adsCount: this.adCount, adPosition: this.getAdPosition(), isPreroll: this.isPreroll, isPAL: !!ad.icon, 
            // We only want to collect the lagTime of the ad didn't start playing
            lagTime: !ad.state.videoStarted && ad.state.startTime ? (0, time_1.timeDiffInMilliseconds)(ad.state.startTime, (0, time_1.now)()) : -1 }, (this.adPreloader ? { adPreloaderLog: this.adPreloader.getDebugInfo() } : {}));
    };
