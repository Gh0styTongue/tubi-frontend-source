...
import OTTFireTVUseQueueImpressions from 'common/experiments/config/ottFireTVUseQueueImpressions';
...
function useExperimentalConfig(props: UseExperimentalProps): ExperimentalConfig {
  ...
  const ottFireTVUseQueueImpressions = useExperiment(OTTFireTVUseQueueImpressions);
  ...
  const experimentalConfig: ExperimentalConfig = {
    ...
    customPlaybackHandlers,
    useQueueImpressions: __OTTPLATFORM__ === 'PS4' || ottFireTVUseQueueImpressions.getValue(),
