...
var AdPreloader_1 = tslib_1.__importDefault(require("../utils/AdPreloader"));
...
var Html5Adapter = /** @class */ (function (_super) {
    ...
    function Html5Adapter(config) {
        ...
        _this.onAdPreloadEviction = function (url, cache) {
            var response = cache.response, utilized = cache.utilized, context = cache.context, size = cache.size;
            var _a = context || {}, adId = _a.adId, adPosition = _a.adPosition, adCount = _a.adCount, isPreroll = _a.isPreroll;
            URL.revokeObjectURL(response);
            if (!utilized) {
                _this.emit(constants_1.PLAYER_EVENTS.adPreloadWastedBandwidth, {
                    url: url,
                    adId: adId,
        ...
        _this.onAdPreloadError = function (response, context, responseHeaders) {
            var _a = context || {}, adId = _a.adId, adPosition = _a.adPosition, adCount = _a.adCount, isPreroll = _a.isPreroll;
            _this.emit(constants_1.PLAYER_EVENTS.adPreloadError, {
        ...
        _this.onAdPreloadTimeout = function (context, responseHeaders) {
            var _a = context || {}, adId = _a.adId, adPosition = _a.adPosition, adCount = _a.adCount, isPreroll = _a.isPreroll;
            _this.emit(constants_1.PLAYER_EVENTS.adPreloadTimeout, {
                adId: adId,
                adPosition: adPosition,
                adCount: adCount,
                isPreroll: isPreroll,
        ...
        _this.onAdPreloadAbort = function (context, responseHeaders) {
            var _a = context || {}, adId = _a.adId, adPosition = _a.adPosition, adCount = _a.adCount, isPreroll = _a.isPreroll;
            _this.emit(constants_1.PLAYER_EVENTS.adPreloadAbort, {
                adId: adId,
                adPosition: adPosition,
                adCount: adCount,
                isPreroll: isPreroll,
        ...
        _this.onAdPreloadSuccess = function (response, context, responseHeaders) {
            var _a = context || {}, adId = _a.adId, adPosition = _a.adPosition, adCount = _a.adCount, isPreroll = _a.isPreroll;
            _this.emit(constants_1.PLAYER_EVENTS.adPreloadSuccess, {
                code: response === null || response === void 0 ? void 0 : response.code,
                message: response === null || response === void 0 ? void 0 : response.message,
                adId: adId,
                adPosition: adPosition,
    ...
    Html5Adapter.prototype.getVideoElement = function () {
        return this.videoElement;
    };
    /**
    ...
    Html5Adapter.prototype.getBufferedLength = function () {
        var _a;
    ...
    Html5Adapter.prototype.setupAdPreloader = function () {
        var adPreloadMethod = this.getExperimentalConfig().adPreloadMethod;
        if (!adPreloadMethod || adPreloadMethod === 'control')
            return;
        if (!this.adPreloader) {
            this.adPreloader = (0, AdPreloader_1.default)({
                maxCacheSize: 80000000,
                maxConcurrentRequests: 1,
                debug: (0, tools_1.isPlayerDebugEnabled)(this.config.debugLevel),
                onEviction: this.onAdPreloadEviction,
                onError: this.onAdPreloadError,
                onTimeout: this.onAdPreloadTimeout,
                onAbort: this.onAdPreloadAbort,
                onSuccess: this.onAdPreloadSuccess,
            });
        }
    };
    Html5Adapter.prototype.preloadAdResponse = function (adResponse, cuePoint, isPreroll) {
        ...
        var _a = this.getExperimentalConfig(), adPreloadMethod = _a.adPreloadMethod, _b = _a.adPreloadTimeout, adPreloadTimeout = _b === void 0 ? (0, time_1.secs)(10) : _b;
        this.setupAdPreloader();
        if (!this.adPreloader)
            return;
        var initialAd = adResponse[0];
        // Ensure the cue point is in the buffered range
        // to prevent the ad preload from competing with the content load
        if (!(0, tools_1.isTimeInBufferedRange)(cuePoint, this.getBufferedAudioRange())) {
            var eventData = {
                bufferedVideoRange: this.getBufferedVideoRange(),
                bufferedAudioRange: this.getBufferedAudioRange(),
                cuePoint: cuePoint,
                reason: 'cue_point_not_in_audio_buffered_range',
                isPreroll: isPreroll,
            };
            this.emit(constants_1.PLAYER_EVENTS.adPreloadPrevented, eventData);
            return;
        }
        if (!(0, tools_1.isTimeInBufferedRange)(cuePoint, this.getBufferedVideoRange())) {
            var eventData = {
                bufferedVideoRange: this.getBufferedVideoRange(),
                bufferedAudioRange: this.getBufferedAudioRange(),
                cuePoint: cuePoint,
                reason: 'cue_point_not_in_video_buffered_range',
                isPreroll: isPreroll,
            };
            this.emit(constants_1.PLAYER_EVENTS.adPreloadPrevented, eventData);
            return;
        }
        if (adPreloadMethod === 'preload_per_ad' && initialAd) {
            this.adPreloader.add(initialAd.video, 1, adPreloadTimeout, {
                adId: initialAd.id,
                adPosition: 0,
        ...
        else if (adPreloadMethod === 'preload_per_ad_pod') {
            for (var idx = 0; idx < adResponse.length; idx++) {
                var ad = adResponse[idx];
                var priority = adResponse.length - idx;
                this.adPreloader.add(ad.video, priority, adPreloadTimeout, {
                    adId: ad.id,
                    adPosition: idx,
                    adCount: adResponse.length,
                    isPreroll: isPreroll,
    ...
    Html5Adapter.prototype.resume = function (isFromPreroll) {
    ...
    Html5Adapter.prototype.load = function (url, position, resumeFromAdData) {
        ...
        var _c = this.config, debugLevel = _c.debugLevel, extensionConfig = _c.extensionConfig, preload = _c.preload;
        var experimentalConfig = this.getExperimentalConfig();
        if (this.config.performanceCollectorEnabled) {
            this.setupPerformanceCollector(resumeFromAdData);
        }
    ...
    Html5Adapter.prototype.destroyExtension = function () {
        var _a, _b;
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var trackDestroyTimeout, exception_2;
            return tslib_1.__generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        this.isDestroyingExtension = true;
                        trackDestroyTimeout = (this.config || {}).trackDestroyTimeout;
                        _c.label = 1;
                    case 1:
                        _c.trys.push([1, 3, , 4]);
                    ...
                    case 3:
                        ...
                        trackDestroyTimeout === null || trackDestroyTimeout === void 0 ? void 0 : trackDestroyTimeout(exception_2.message);
                        return [3 /*break*/, 4];
                    case 4:
    ...
    Html5Adapter.prototype.setupAdPlayer = function (adResponse) {
        ...
        if (!this.adPlayer) {
            ...
            var adPlayerOptions = {
                ...
                adPreloadMethod: experimentalConfig.adPreloadMethod,
                adPreloadTimeout: (_a = experimentalConfig.adPreloadTimeout) !== null && _a !== void 0 ? _a : (0, time_1.secs)(10),
                adPreloadFallbackImmediately: experimentalConfig.adPreloadFallbackImmediately,
                ...
                adPreloader: this.adPreloader,
                useQueueImpressions: experimentalConfig.useQueueImpressions,
