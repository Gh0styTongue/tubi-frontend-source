...
import { trackAdPreloadAbort } from '../track/client-log/trackAdPreloadAbort';
import { trackAdPreloadError } from '../track/client-log/trackAdPreloadError';
import { trackAdPreloadPrevented } from '../track/client-log/trackAdPreloadPrevented';
import { trackAdPreloadSuccess } from '../track/client-log/trackAdPreloadSuccess';
import { trackAdPreloadTimeout } from '../track/client-log/trackAdPreloadTimeout';
import { trackAdPreloadWastedBandwidth } from '../track/client-log/trackAdPreloadWastedBandwidth';
...
export const attachVODTracking = (
  ...
  // Ad Preload Events
  player.on(PLAYER_EVENTS.adPreloadWastedBandwidth, trackAdPreloadWastedBandwidth);
  player.on(PLAYER_EVENTS.adPreloadError, trackAdPreloadError);
  player.on(PLAYER_EVENTS.adPreloadSuccess, trackAdPreloadSuccess);
  player.on(PLAYER_EVENTS.adPreloadTimeout, trackAdPreloadTimeout);
  player.on(PLAYER_EVENTS.adPreloadAbort, trackAdPreloadAbort);
  player.on(PLAYER_EVENTS.adPreloadPrevented, trackAdPreloadPrevented);
  ...
  return () => {
    ...
    // Ad Preload Events
    player.removeListener(PLAYER_EVENTS.adPreloadWastedBandwidth, trackAdPreloadWastedBandwidth);
    player.removeListener(PLAYER_EVENTS.adPreloadError, trackAdPreloadError);
    player.removeListener(PLAYER_EVENTS.adPreloadTimeout, trackAdPreloadTimeout);
    player.removeListener(PLAYER_EVENTS.adPreloadAbort, trackAdPreloadAbort);
    player.removeListener(PLAYER_EVENTS.adPreloadPrevented, trackAdPreloadPrevented);
    player.removeListener(PLAYER_EVENTS.adPreloadSuccess, trackAdPreloadSuccess);
  };
};
