...
const WebErrorModal: React.FunctionComponent<WebErrorModalProps> = ({ isOpen, onClose, playerErrorDetails }) => {
  ...
  const getModalHeadMsg = () => {
    ...
    switch (playerErrorDetails) {
      ...
      case PLAYER_ERROR_DETAILS.PURPLE_CARPET_LIVE_PLAYBACK_ERROR:
        message = intl.formatMessage(messages.errorTitleLive);
        break;
  ...
  const getModalBody = () => {
    ...
    } if (playerErrorDetails === PLAYER_ERROR_DETAILS.PURPLE_CARPET_LIVE_PLAYBACK_ERROR) {
      return (<section className={styles.webErrorModalContentBodyDescription}>
        <p>
          <b>{intl.formatMessage(messages.errorContentLive1)}</b>
        </p>
        ...
        <ul>
          <li>{intl.formatMessage(messages.errorContentLive2)}</li>
          <li>{intl.formatMessage(messages.errorContentLive3)}</li>
        </ul>
        <p>
          <b>{intl.formatMessage(messages.errorContentAdditionalHelp1)}</b>
        </p>
