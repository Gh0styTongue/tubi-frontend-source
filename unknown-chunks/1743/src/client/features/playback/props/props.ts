  ...
  switch (__OTTPLATFORM__) {
    ...
    case 'LGTV': {
      ...
      platformSpecificProps = {
        ...
        stallMinimumDurationMS: stallMinimumDurationMS || 550,
      };
      break;
    }
    case 'FIRETV_HYB':
    ...
    case 'XBOXONE':
      ...
      platformSpecificProps = {
        ...
        forceFilterDrmKeySystemWithConfig: true,
      };
      break;
    case 'COMCAST':
      platformSpecificProps = {
    ...
    case 'PS4':
      ...
      if (useHlsNext) {
        ...
        platformSpecificProps.highBufferWatchdogPeriod = 8;
        platformSpecificProps.maxStarvationDelay = 2;
      }
      break;
    case 'PS5':
      platformSpecificProps = {
    ...
    case 'TIZEN':
      ...
      if (useHlsNext) {
        platformSpecificProps.forceFilterDrmKeySystemWithConfig = true;
        platformSpecificProps.highBufferWatchdogPeriod = 8;
        platformSpecificProps.disableMediaKeySessionRemove = true;
      }
      break;
    case 'TIVO':
      platformSpecificProps.forceFilterDrmKeySystemWithConfig = true;
