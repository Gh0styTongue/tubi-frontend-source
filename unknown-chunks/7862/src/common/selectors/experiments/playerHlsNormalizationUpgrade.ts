...
import { getConfig as PS4Config } from 'common/experiments/config/ottPS4HlsUpgrade';
...
export const playerHlsNormalizationUpgradeSelector = (state: StoreState): boolean => {
  ...
  // On Samsung 2015 and Samsung 2016 hls 1.2.7 doesn't
  // properly buffer content and seems to manipulate PTS whereas
  // 1.5.7 the "normalization" version works fine.
  if (__OTTPLATFORM__ === 'TIZEN' && isSamsungBefore2017()) return true;
