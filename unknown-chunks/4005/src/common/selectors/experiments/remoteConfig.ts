...
export const livePerformanceMetricEnabledSelector = createSelector(
  ...
  () => __IS_E2E_TEST__,
  (deviceId, hasPerformanceApi, featureSwitch, isE2ETest) => hasPerformanceApi && (sampleString(deviceId, rate.performance.live, 'livePerformanceMetric') || featureSwitch || isE2ETest),
);
...
export const vodPerformanceMetricEnabledSelector = createSelector(
  ...
  () => FeatureSwitchManager.isEnabled(['Player', 'Performance']),
  () => __IS_E2E_TEST__,
  (deviceId, hasPerformanceApi, featureSwitch, isE2ETest) => hasPerformanceApi && (sampleString(deviceId, rate.performance.vod, 'vodPerformanceMetric') || featureSwitch || isE2ETest),
);
...
export const previewPerformanceMetricEnabledSelector = createSelector(
  ...
  () => FeatureSwitchManager.isEnabled(['Player', 'Performance']),
  () => __IS_E2E_TEST__,
  (deviceId, hasPerformanceApi, featureSwitch, isE2ETest) => hasPerformanceApi && (sampleString(deviceId, rate.performance.preview, 'previewPerformanceMetric') || featureSwitch || isE2ETest),
);
...
export const uiNavigationPerformanceMetricEnabledSelector = createSelector(
  ...
  () => hasNecessaryPerformanceApi(),
  () => __IS_E2E_TEST__,
  (deviceId, hasPerformanceApi, isE2ETest) => hasPerformanceApi && (sampleString(deviceId, 0.1, 'uiNavigationPerformanceMetric') || isE2ETest),
