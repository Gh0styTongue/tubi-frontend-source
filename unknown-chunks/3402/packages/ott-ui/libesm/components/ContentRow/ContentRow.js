...
import { NON_FEATURED_VISIBLE_TILES } from '../../constants/ui';
...
var ContentRow = function (_a) {
    var _b = _a.animated, animated = _b === void 0 ? true : _b, _c = _a.enabledHeaderTransition, enabledHeaderTransition = _c === void 0 ? true : _c, fade = _a.fade, fadeLight = _a.fadeLight, large = _a.large, larger = _a.larger, isNew = _a.isNew, labelText = _a.labelText, showHeader = _a.showHeader, showIndicator = _a.showIndicator, title = _a.title, activeNumber = _a.activeNumber, totalNumber = _a.totalNumber, style = _a.style, className = _a.className, headerClassName = _a.headerClassName, children = _a.children, header = _a.header, isPromoRow = _a.isPromoRow, attributes = __rest(_a, ["animated", "enabledHeaderTransition", "fade", "fadeLight", "large", "larger", "isNew", "labelText", "showHeader", "showIndicator", "title", "activeNumber", "totalNumber", "style", "className", "headerClassName", "children", "header", "isPromoRow"]);
    var outerCls = classNames(className, 'ott-content-row-wrapper', {
        'ott-content-row-wrapper__fade': fade,
        'ott-content-row-wrapper__fade-light': fadeLight,
...
var ContentRowPlaceholder = function (_a) {
    ...
    var placeholders = useMemo(function () {
        return Array.from({ length: NON_FEATURED_VISIBLE_TILES + 1 }, // + 1 for the translucent tile in the end
