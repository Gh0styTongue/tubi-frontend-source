...
var Attributes = function (_a) {
    var badges = _a.badges, _b = _a.is4K, is4K = _b === void 0 ? false : _b, cc = _a.cc, audioDescriptionsAvailable = _a.audioDescriptionsAvailable, label = _a.label, year = _a.year, duration = _a.duration, descriptor = _a.descriptor, rating = _a.rating, tags = _a.tags, channelLogo = _a.channelLogo, channelUrl = _a.channelUrl, channelLogoAltText = _a.channelLogoAltText, timeLeft = _a.timeLeft, subTitle = _a.subTitle, oneLineAttributes = _a.oneLineAttributes, seriesSeasonNum = _a.seriesSeasonNum;
    return (React.createElement("div", { className: "web-attributes" },
        !oneLineAttributes && badges && badges.length > 0 ? React.createElement("div", { className: "web-attributes__badges" }, badges) : null,
        React.createElement("div", { className: classNames('web-attributes__meta', { 'web-attributes__meta--with-label': !!label }) },
            label,
            subTitle || year || duration || seriesSeasonNum || oneLineAttributes ? React.createElement("span", { className: "web-attributes__year-duration" }, [subTitle, year, duration, getSeriesSeasonNum(seriesSeasonNum), getTags(oneLineAttributes, tags)].filter(Boolean).join(' · ')) : null,
