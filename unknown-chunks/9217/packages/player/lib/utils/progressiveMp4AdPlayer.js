...
var ProgressiveMp4AdPlayer = /** @class */ (function (_super) {
    ...
    function ProgressiveMp4AdPlayer(options) {
        ...
        _this.onHealthScoreLow = function (scores) {
            var currentAd = _this.getCurrentAdWithState();
            if (!currentAd || !_this.videoElement) {
                return;
            }
            var skipAd = _this.options.skipAdWithHealthScore !== "only_error" /* AD_HEALTH_OPTIONS.CONTROL */;
            ...
            if (currentAd && skipAd) {
                _this.skipBrokenAd({ code: constants_1.PLAYER_EVENTS.adHealthScoreLow, message: constants_1.PLAYER_EVENTS.adHealthScoreLow }, currentAd);
            }
        };
