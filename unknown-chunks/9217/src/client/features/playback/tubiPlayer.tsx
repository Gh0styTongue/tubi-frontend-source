...
import { AdMissedReason, trackAdMissed } from 'client/features/playback/track/client-log';
...
export const attachPlayerEvents = (player: Player, config: {
  ...
  const detachAdHealthScoreLow = attachAdHealthScoreLowEvent(player, youboraExperimentMap);
