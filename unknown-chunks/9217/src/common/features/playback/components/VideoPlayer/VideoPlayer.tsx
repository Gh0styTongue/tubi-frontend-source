...
class VideoPlayerClassComponent extends Component<VideoPlayerClassComponentProps> {
  ...
  async buildPlayer() {
    ...
    const player = createPlayer({
      ...
      experimentalConfig: {
        ...
        minResumeStartupBufferDataLength: experimentalConfig?.minResumeStartupBufferDataLength,
      },
  ...
  /**
   * render just returns the element.
   * we pass this element #jwContainer to jw api to place the player
   */
  render() {
...
const VideoPlayer: React.FC<VideoPlayerProps> = (props) => {
  const { customAdapter, onPlayerCreate, prerollUrl } = props;
  const intl = useIntl();
