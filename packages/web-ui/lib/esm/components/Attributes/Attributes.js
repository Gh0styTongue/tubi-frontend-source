...
var getSeriesSeasonNum = function (seriesSeasonNum, seriesSeasonNumDisplayText) {
    if (!seriesSeasonNum) {
        return;
    }
    if (seriesSeasonNumDisplayText) {
        return " ".concat(seriesSeasonNumDisplayText);
    }
...
var Attributes = function (_a) {
    var badges = _a.badges, _b = _a.is4K, is4K = _b === void 0 ? false : _b, cc = _a.cc, audioDescriptionsAvailable = _a.audioDescriptionsAvailable, label = _a.label, year = _a.year, duration = _a.duration, descriptor = _a.descriptor, rating = _a.rating, tags = _a.tags, channelLogo = _a.channelLogo, channelUrl = _a.channelUrl, channelLogoAltText = _a.channelLogoAltText, timeLeft = _a.timeLeft, subTitle = _a.subTitle, oneLineAttributes = _a.oneLineAttributes, seriesSeasonNum = _a.seriesSeasonNum, isBadgeAfterRating = _a.isBadgeAfterRating, runTime = _a.runTime, isNewDesign = _a.isNewDesign, seriesSeasonNumDisplayText = _a.seriesSeasonNumDisplayText;
    /* istanbul ignore next */
    return (React.createElement("div", { className: classNames('web-attributes', { 'web-attributes__new-design': isNewDesign }) },
        ...
        React.createElement("div", { className: classNames('web-attributes__meta', { 'web-attributes__meta--with-label': !!label }) },
            label,
            subTitle || year || duration || seriesSeasonNum || oneLineAttributes || runTime ? React.createElement("span", { className: "web-attributes__year-duration" }, [subTitle, year, duration, getSeriesSeasonNum(seriesSeasonNum, seriesSeasonNumDisplayText), runTime, getTags(oneLineAttributes, tags)].filter(Boolean).join(' · ')) : null,
