...
var ChannelRow = function (_a) {
    ...
    var _c = useState(false), hasBeenEnteredView = _c[0], setHasBeenEnteredView = _c[1];
    useEffect(function () {
        if (isInView) {
            setHasBeenEnteredView(true);
        }
    }, [id, isInView]);
    useEffect(function () {
        if (hasBeenEnteredView) {
            onEnteredView === null || onEnteredView === void 0 ? void 0 : onEnteredView(id, index);
        }
    }, [id, hasBeenEnteredView, onEnteredView, index]);
