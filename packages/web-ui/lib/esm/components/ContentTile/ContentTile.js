...
var ContentTile = forwardRef(function (_a, ref) {
    ...
    var zoomPoster = isPreviewEnabled ? showPreview : isHovered && !isLocked;
    ...
    var previewTransition = {
        entranceTransition: 'scaleInUp',
        exitTransition: 'scaleOutDown',
    };
    if (previewAnchor === 'right') {
        previewTransition.entranceTransition = 'scaleInUpRight';
        previewTransition.exitTransition = 'scaleOutDownRight';
    }
    else if (previewAnchor === 'left') {
        previewTransition.entranceTransition = 'scaleInUpLeft';
        previewTransition.exitTransition = 'scaleOutDownLeft';
    }
    return (React.createElement("div", { "data-test-id": "web-ui-content-tile", ref: ref, className: classNames('web-content-tile', className, { 'web-content-tile__new-design': isNewDesign }), style: style, onClick: clickHandler, 
        ...
        React.createElement("div", { className: "web-content-tile__container" },
            React.createElement("div", { className: classNames('web-content-tile__poster', { 'web-content-tile__poster-zoomed': zoomPoster }) },
                React.createElement(Poster, { alt: title, zoom: isNewDesign ? false : zoomPoster, tileOrientation: tileOrientation, progress: progress, hideProgress: (zoomPoster && hasExtraActions) || hideProgress, src: src, srcSet: srcSet, sizes: sizes, fetchPriority: fetchPriority, lazyActive: lazyActive, lazyLoad: lazyLoad, preload: preload, enablePreview: isPreviewEnabled, previewAnchor: previewAnchor }),
