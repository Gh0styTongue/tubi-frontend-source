...
var customHlsLoader_1 = require("../utils/customHlsLoader");
...
var WebAdapter = /** @class */ (function (_super) {
    ...
    function WebAdapter(config) {
        ...
        _this.onTimeupdate = function () {
            var _a = _this.videoElement, position = _a.currentTime, readyState = _a.readyState;
            ...
            var hasBufferedData = _this.getBufferedRange().length > 0;
        ...
        _this.onLeavePictureInPicture = function () {
    ...
    WebAdapter.prototype.setupExtensionPlayback = function () {
        ...
        var _b = this.config, extensionConfig = _b.extensionConfig, licenseUrl = _b.licenseUrl, drmKeySystem = _b.drmKeySystem, experimentalConfig = _b.experimentalConfig;
        var hlsConfig = tslib_1.__assign(tslib_1.__assign({ debug: this.config.debugLevel === constants_1.PLAYER_LOG_LEVEL.SDK_LEVEL, maxBufferSize: 30 * 1000 * 1000, maxMaxBufferLength: 180 }, ((experimentalConfig === null || experimentalConfig === void 0 ? void 0 : experimentalConfig.useCustomLoader) ? { loader: (0, customHlsLoader_1.createCustomLoaderClass)(WebAdapter.Hls) } : {})), ((0, types_1.isHlsExtensionConfig)(extensionConfig) ? extensionConfig.hls : {}));
        if (licenseUrl) {
            switch (drmKeySystem) {
        ...
        this.emit(constants_1.PLAYER_EVENTS.hlsSetup, { hlsInstance: this.hls, ExternalHls: WebAdapter.Hls });
        (_a = this.performanceCollector) === null || _a === void 0 ? void 0 : _a.setHls(this.hls);
        this.detachVideoElementEvents = this.attachVideoElementEvents();
        this.attachPlayerEvents();
        this.hls.attachMedia(this.videoElement);
        this.mediaAttachTimer = setTimeout(function () {
            /* istanbul ignore next */
            _this.onVideoElementError(new Error('Media attach timeout.'));
        }, MEDIA_ATTACH_TIMEOUT);
    };
    WebAdapter.prototype.setup = function () {
     ...
     */
    WebAdapter.prototype.load = function () {
        return tslib_1.__awaiter(this, arguments, void 0, function (options) {
            var isAfterAd, isResumeFromPreroll, _a, drmKeySystem, performanceCollectorEnabled;
            var _this = this;
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        isAfterAd = options.isAfterAd, isResumeFromPreroll = options.isResumeFromPreroll;
    ...
    WebAdapter.prototype.shouldReuseVideoElement = function () {
        ...
        return this.config.reuseVideoElement;
    };
    ...
    WebAdapter.prototype.getCurrentVideoElement = function () {
        var _a;
        return ((_a = this.adClient) === null || _a === void 0 ? void 0 : _a.getVideoElement()) || this.videoElement;
    };
    WebAdapter.prototype.getContentVideoElement = function () {
    ...
    WebAdapter.prototype.getBufferedVideoRange = function () {
        if (this.isAd()) {
            return this.adClient.getBufferedRange();
        }
        /* istanbul ignore next */
        if (!this.hls)
            return [];
    ...
    WebAdapter.prototype.getBufferedLength = function (maxHoleDuration) {
     ...
     */
    WebAdapter.prototype.getAdDuration = function () {
        var _a;
        return (_a = this.adClient) === null || _a === void 0 ? void 0 : _a.getAdDuration();
    };
    /**
    ...
    WebAdapter.prototype.getBandwidthEstimate = function () {
        ...
        var estimate = this.hls.bandwidthEstimate;
    ...
    WebAdapter.prototype.playAdResponse = function (adResponse, config) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _a, metrics, requestPosition, isResumeFromPreroll, exception_2;
            var _b;
            return tslib_1.__generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 5:
                        ...
                        this.setupAdClient().playAdResponse(adResponse);
                        return [2 /*return*/];
                }
            });
        });
    };
    WebAdapter.prototype.resume = function (resumeConfig) {
        var _a, _b;
    ...
    WebAdapter.prototype.isAd = function () {
        return this.adClient !== undefined;
    };
    ...
    WebAdapter.prototype.init = function () {
        ...
        var shouldMute = typeof mute === 'undefined' ? (0, volume_1.getStoredMuteState)() : mute;
        if (shouldMute) {
            this.setVideoElementMute(true);
        }
        var volume = (0, volume_1.getStoredVolume)();
        if (volume !== null) {
            this.setVideoElementVolume(volume);
        }
        if (captionsStyles)
    ...
    WebAdapter.prototype.setupFairPlay = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _a, drmKeySystem, licenseUrl, serverCertificateUrl, req, cert;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        this.log('setup FairPlay');
                        _a = this.config, drmKeySystem = _a.drmKeySystem, licenseUrl = _a.licenseUrl, serverCertificateUrl = _a.serverCertificateUrl;
                        return [4 /*yield*/, (0, fetchWrapper_1.xhrRequest)(serverCertificateUrl, { responseType: 'arraybuffer' })];
                    case 1:
                        req = _b.sent();
    ...
    WebAdapter.prototype.startBuffering = function (reason) {
        ...
        var bufferingType = this.hasEnoughBufferToPlay() ? 'unknown' : 'network';
    ...
    WebAdapter.prototype.setupAdClient = function () {
        ...
        this.adClient = new progressiveMp4AdPlayer_1.default({
            ...
            skipAdWithHealthScore: experimentalConfig === null || experimentalConfig === void 0 ? void 0 : experimentalConfig.skipAdWithHealthScore,
            /**
            ...
            */
            ...
            impressionRequirement: 'none',
            onlyRespectImpressionRequirementAfterCodeSkip: false,
            disableAdStallSkipImpressionRequirement: false,
            maxEstimatedTimeCostMultiplier: constants_1.MAX_ESTIMATED_TIME_COST_MULTIPLIER,
        });
        this.attachAdClientEvents(this.adClient);
        return this.adClient;
    };
    ...
    WebAdapter.prototype.attachAdClientEvents = function (adClient) {
        var _this = this;
        var resumeContentPlayback = function (isFromPreroll) {
            _this.showCaptions();
            if (_this.adClient) {
                _this.adClient.remove();
        ...
        adClient.on(constants_1.PLAYER_EVENTS.adStart, function () {
            _this.hideCaptions();
        });
        ...
        this.setupProxyAdPlayerEvents(adClient, this.log.bind(this));
    };
    WebAdapter.prototype.attachVideoElementEvents = function () {
        ...
        var listenerMap = {
            ...
            leavepictureinpicture: this.onLeavePictureInPicture,
        };
    ...
    WebAdapter.prototype.attachPlayerEvents = function () {
        ...
        this.hls.on(Hls.Events.MEDIA_ATTACHED, function (event, data) {
            ...
            _this.loadSource();
            clearTimeout(_this.mediaAttachTimer);
        });
    ...
    WebAdapter.prototype.setMediaUrl = function (mediaUrl_1) {
    ...
    WebAdapter.prototype.enterPictureInPicture = function () {
        /* istanbul ignore else */
    ...
    WebAdapter.prototype.hasEnoughBufferToPlay = function () {
        var currentTime = this.videoElement.currentTime;
    ...
    WebAdapter.prototype.getIsAdFetching = function () {
