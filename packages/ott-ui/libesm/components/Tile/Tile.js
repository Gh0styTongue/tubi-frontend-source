...
var Tile = function (_a) {
    var className = _a.className, selectorClassName = _a.selectorClassName, fade = _a.fade, fadeOut = _a.fadeOut, isLiveDesign = _a.isLiveDesign, contentWithinTile = _a.contentWithinTile, percentComplete = _a.percentComplete, _b = _a.showSelector, showSelector = _b === void 0 ? false : _b, _c = _a.type, type = _c === void 0 ? 'portrait' : _c, size = _a.size, text = _a.text, subText = _a.subText, id = _a.id, style = _a.style, expiry = _a.expiry, renderedImage = _a.renderedImage, children = _a.children, _d = _a.animated, animated = _d === void 0 ? false : _d, _e = _a.speed, speed = _e === void 0 ? 'default' : _e, rank = _a.rank, attributes = __rest(_a, ["className", "selectorClassName", "fade", "fadeOut", "isLiveDesign", "contentWithinTile", "percentComplete", "showSelector", "type", "size", "text", "subText", "id", "style", "expiry", "renderedImage", "children", "animated", "speed", "rank"]);
    ...
    var wrapperCls = classNames('ott-tile-wrapper', className, type, size !== 'normal' && size, {
        ...
        'ott-tile-wrapper--animated-fast': animated && speed === 'fast',
        'with-rank': rankImage,
    ...
    var isFullOpacity = !(fade || fadeOut);
