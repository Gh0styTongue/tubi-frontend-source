...
function HeroBackground(_a) {
    var src = _a.src, className = _a.className, style = _a.style, isFullScreen = _a.isFullScreen;
    var backgroundImage = src ? "".concat(toCSSUrl(src)) : '';
    var styleWithBackgroundImage = __assign({ backgroundImage: backgroundImage }, style);
    return (React.createElement("div", { className: classNames('web-hero-background', className, {
