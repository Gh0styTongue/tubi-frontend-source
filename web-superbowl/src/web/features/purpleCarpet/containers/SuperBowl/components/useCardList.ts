  ...
  return [
    {
      ...
      description: 'Join us for FOX\'s expansive pregame coverage, including the Road to Super Bowl LIX, The Madden Cruiser: A Bayou Adventure with Bill Belichick, and the FOX Super Bowl LIX Pregame.',
