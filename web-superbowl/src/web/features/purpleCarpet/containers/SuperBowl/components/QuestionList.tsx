...
import { SB_HELP_CENTER_URL } from 'web/features/purpleCarpet/containers/SuperBowl/sb-constants';
...
const messages = defineMessages({
  ...
  answer5: {
    defaultMessage:
      'Super Bowl LIX kick off is at 6:30 PM ET. You can join us early for both the official FOX Pre-Game Show at 11:30 AM ET and the exclusive Tubi Red Carpet at 3:30 PM ET.',
    description: 'faq answer',
  },
  question11: {
...
const QuestionList: React.FC<any> = ({ isSuperbowlPage }: { isSuperbowlPage?: boolean }) => {
