  ...
  _createClass(Row, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          attributes = _objectWithoutProperties(_this$props, ["tag", "noGutters", "nodeRef", "className"]);

      var classes = (0, _classnames.default)('Row', {
...
exports.default = Row;
Row.propTypes = {
  /** Container tag name, or functional component */
  tag: _propTypes.default.oneOfType([_propTypes.default.func, _propTypes.default.string]),

  /**
   * remove the negative margin from .Row, then the horizontal padding
