...
export class DevicesPage extends Component<DevicesPageProps, OwnState> {
  ...
  private devices: { title: string | JSX.Element, key: string, element: JSX.Element, text: string | JSX.Element, requirements?: string, imageUrl: string, path: string }[][];
      ...
      [
        {
          ...
          imageUrl: '//cdn.adrise.tv/tubitv-assets/img/devices/roku-repaint.png',
        ...
        },
        {
          ...
          imageUrl: '//cdn.adrise.tv/tubitv-assets/img/devices/appletv-repaint.png',
        ...
        },
        {
          ...
          imageUrl: '//cdn.adrise.tv/tubitv-assets/img/devices/amazontv-repaint.png',
        ...
        },
        {
          ...
          imageUrl: '//cdn.adrise.tv/tubitv-assets/img/devices/xbox-series-x-repaint.png',
        ...
        },
        {
          ...
          imageUrl: '//cdn.adrise.tv/tubitv-assets/img/devices/playstation5-repaint.png',
        ...
        },
        {
          ...
          imageUrl: '//cdn.adrise.tv/tubitv-assets/img/devices/chromecast-repaint.png',
        ...
        },
        {
          ...
          imageUrl: '//cdn.adrise.tv/tubitv-assets/img/devices/tivo-repaint.png',
        ...
        },
        {
          ...
          imageUrl: '//cdn.adrise.tv/tubitv-assets/img/devices/ott.png',
        ...
        },
        {
          ...
          imageUrl: '//cdn.adrise.tv/tubitv-assets/img/devices/xfinity-med-repaint.png',
        ...
        },
        {
          ...
          imageUrl: '//cdn.adrise.tv/tubitv-assets/img/devices/cox-repaint.png',
      ...
      [
        {
          ...
          imageUrl: '//cdn.adrise.tv/tubitv-assets/img/devices/samsungtv-repaint.png',
          path: '/static/devices?device=samsung',
        },
        {
          title: 'Sony',
          ...
          imageUrl: '//cdn.adrise.tv/tubitv-assets/img/devices/sony-repaint.png',
      ...
      [
        {
          ...
          imageUrl: '//cdn.adrise.tv/tubitv-assets/img/devices/ipadiphone-repaint.png',
          path: '/static/devices?device=ios',
          downloadBadge: <AppStoreBadge isSpanishLanguage={false} className={styles.storeBadge} />,
        },
        {
          title: 'Android',
          key: 'android',
          ...
          href: 'https://play.google.com/store/apps/details?id=com.tubitv',
          imageUrl: '//cdn.adrise.tv/tubitv-assets/img/devices/android-repaint.png',
          path: '/static/devices?device=android',
          downloadBadge: <GooglePlayBadge isSpanishLanguage={false} className={styles.storeBadge} />,
        },
        {
          title: 'Windows',
          key: 'windows',
          ...
          imageUrl: '//cdn.adrise.tv/tubitv-assets/img/devices/windowstablet-repaint.png',
      ...
      [
        {
          ...
          imageUrl: '//cdn.adrise.tv/tubitv-assets/img/devices/webdesktop-repaint.png',
          path: '/static/devices?device=web',
          href: '/home',
        },
      ],
