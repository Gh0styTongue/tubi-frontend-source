...
const IosIconRectangle: React.FunctionComponent<SvgIconProps> = (props): React.ReactElement<SvgIconType> => (
  <SvgIcon viewBox="-4 -2 60 30" {...props} role="img">
...
export default IosIconRectangle;
