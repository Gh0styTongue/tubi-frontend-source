...
const landingPageMessages = defineMessages({
  ...
  majorEventHeader1: {
    description: 'major event header texts 1',
    defaultMessage: 'Sign in to watch for free',
  },
  majorEventHeader2: {
    description: 'major event header texts 2',
    defaultMessage: 'LIVE SPORTS',
  },
  majorEventSubheader1: {
    description: 'major event subheader text 1',
    defaultMessage: 'Plus thousands of Movies and TV shows.',
  },
  majorEventSubheader2: {
    description: 'major event subheader text 2',
    defaultMessage: 'Always free. 100% Legal.',
  },
});
...
export const LANDING_PAGE_TEXT = {
  ...
  majorEvent: {
    header: [
      landingPageMessages.majorEventHeader1,
      landingPageMessages.majorEventHeader2,
    ],
    subheader: [
      landingPageMessages.majorEventSubheader1,
      landingPageMessages.majorEventSubheader2,
    ],
  },
};
