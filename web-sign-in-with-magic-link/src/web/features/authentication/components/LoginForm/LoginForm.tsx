...
export interface LoginFormProps extends OwnProps, StateProps {
  intl: IntlShape;
}
...
export const LoginForm: React.FC<AllProps> = (props) => {
  ...
  const handleSignInWithoutPassword = () => {
...
export default connect(mapStateToProps)(injectIntl(LoginFormWithFormik));
